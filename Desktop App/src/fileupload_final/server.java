...
class SwingControlServer extends JFrame {
    ...
    protected static void start() throws IOException {
        // TODO Auto-generated method stub
         System.out.println(" Upload Server running...");
            ...
            System.out.println("Upload Server accepted client");
            InputStream inputStream=socket.getInputStream();
            byte[] readbyte=new byte[(1024*10)*1024];           


            FileOutputStream fileOutputStream=new FileOutputStream("E:/test/hello21.zip");
            int writebyte;
            int count=0;
