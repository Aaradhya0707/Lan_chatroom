 ...
 */
package Final_chat_room;

/**
 *
 * @author Aaradhya Agrawal
 */
import javax.swing.*;
import java.awt.*;
...
s=new Socket("192.168.128.8",1004); //creates a socket object
s1=new Socket("192.168.128.8",1004);
s2=new Socket("192.168.128.8",1004);
//create inputstream for a particular socket
din=new DataInputStream(s.getInputStream());
//create outputstream
dout=new DataOutputStream(s.getOutputStream());
//sending a message for login
JOptionPane.showMessageDialog(null, (name+" has Logged in"));
